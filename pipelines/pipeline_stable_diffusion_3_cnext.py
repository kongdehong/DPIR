...
class StableDiffusion3ControlNetPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    def encode_prompt(
        ...
        print(f"prompt:{prompt_embeds.shape}, negative_prompt:{negative_prompt_embeds.shape}")
        print(f"pooled_prompt:{pooled_prompt_embeds.shape}, pooled_negative_prompt:{negative_pooled_prompt_embeds.shape}")
